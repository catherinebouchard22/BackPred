...
class CNNLayerVisualization():
    ...
    def __init__(self, selected_filter):
        self.model = Net()
        self.model.load_state_dict(torch.load('mnist_14_model.pth'))
    ...
    def visualise_layer_with_hooks(self):
        ...
        self.created_image = np.float32(processed_image.cpu().detach().squeeze())
        np.save('{}'.format(self.selected_filter), self.created_image)
